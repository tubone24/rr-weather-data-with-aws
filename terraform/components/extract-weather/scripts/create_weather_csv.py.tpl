...
applymapping1 = ApplyMapping.apply(frame=datasource0, mappings=[("calendar_date", "string", "date", "string"),
                                                                ("avg_temperature", "double", "avg_temperature", "double"),
                                                                ("high_temperature", "double", "high_temperature", "double"),
                                                                ("low_temperature", "double", "low_temperature", "double"),
                                                                ("precipitation", "double", "precipitation", "double"),
                                                                ("hours_sunlight", "double", "hours_sunlight", "double"),
                                                                ("solar_radiation", "double", "solar_radiation", "double"),
                                                                ("avg_wind_speed", "double", "avg_wind_speed", "double")],
